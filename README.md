...
This project analyzes intern performance using a structured dataset to derive meaningful insights.

---

## Sprint 1 – Data Collection & Preprocessing

* Created dataset using Python in Google Colab
* Loaded dataset into DataFrame for analysis
...
* `Internship Analysis Dashboard.pbix` → Visualization using Power BI
